    ...
    public partial class Add_Table_GuidePagesMenuInfo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 3, 25, 14, 57, 48, 532, DateTimeKind.Local).AddTicks(9300), 0, "首页", 1, "http://home.fanghua.host", 0 },
                    { 2, new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(651), 0, "Mr.Fang♥Mrs.Zhou", 2, "http://fh.fanghua.host", 0 },
                    ...
                    { 4, new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(664), 0, "微信", 4, "http://fanghua.host/accsets/images/weixin.jpg", 0 },
                    { 5, new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(665), 0, "表白小工具", 5, "http://devlove.fanghua.host", 0 },
                    { 6, new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(666), 0, "实用小工具", 6, "http://tool.fanghua.host", 0 },
                    { 7, new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(667), 0, "休闲小游戏", 7, "http://game.fanghua.host", 0 }
                });
        }
