            ...
            modelBuilder.Entity("M.Model.Entity.DevLoveInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DLId = 1,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 531, DateTimeKind.Local).AddTicks(9184),
                            DLDay = "6",
            ...
            modelBuilder.Entity("M.Model.Entity.GuidePagesMenuInfo", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MenuID = 1,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 532, DateTimeKind.Local).AddTicks(9300),
                            IsDeleted = 0,
                            MenuName = "首页",
                            MenuOrder = 1,
                        ...
                        {
                            MenuID = 2,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(651),
                            IsDeleted = 0,
                        ...
                        {
                            MenuID = 3,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(663),
                            IsDeleted = 0,
                            MenuName = "QQ",
                            MenuOrder = 3,
                        ...
                        {
                            MenuID = 4,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(664),
                            IsDeleted = 0,
                            MenuName = "微信",
                            MenuOrder = 4,
                        ...
                        {
                            MenuID = 5,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(665),
                            IsDeleted = 0,
                            MenuName = "表白小工具",
                            MenuOrder = 5,
                        ...
                        {
                            MenuID = 6,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(666),
                            IsDeleted = 0,
                            MenuName = "实用小工具",
                            MenuOrder = 6,
                        ...
                        {
                            MenuID = 7,
                            CreateTime = new DateTime(2020, 3, 25, 14, 57, 48, 533, DateTimeKind.Local).AddTicks(667),
                            IsDeleted = 0,
                            MenuName = "休闲小游戏",
                            MenuOrder = 7,
